if (mouse_check_button_pressed(mb_left)) {
    ...
    if (point_in_rectangle(mx, my, chat_icon_x, chat_icon_y, chat_icon_x + chat_icon_size, chat_icon_y + chat_icon_size)) {
...
if (mouse_check_button_pressed(mb_left) && chat_expanded) {
    var mx = device_mouse_x_to_gui(0);
    var my = device_mouse_y_to_gui(0);
